function [mAP,mAP_euclidian] = MyRetrieval(Wx,D,X_1_test , X_2_test ,Z_1_test,Z_2_test, ld , D_power)
...
for i = 1:n_1_t
    ...
    count_euclidian = 0;
    for j = 1 :n_2_t
        label_similarity = f_similarity(Z_1_test(i,:),Z_2_test(index(i,j),:),"dot_product")==1;
