...
%labelsimilarity >>>>>>>>>>>>>>WHAT IS THIS ? It is the f function, dot or 12 exponential <<<<<
% few = number of pairs to be introduced >>>>>>>>>>>>>WHAT IS THIS ? at
% time of retrieval it is the top few retrieved data points which are
% considered in metric calculation. It is also used in KNN why?
